...
class Product extends Model
{
    ...
    public static function newProduct($request)
    {
        ...
        self::$newItem->product_category    = $request->product_category;
        self::$newItem->name                = $request->name;
        self::$newItem->price               = $request->price;
        self::$newItem->product_unit        = $request->product_unit;
    ...
    public static function updateProduct($request)
    {
        ...
        self::$updateItem->product_category = $request->product_category;
        self::$updateItem->name = $request->name;
        self::$updateItem->price = $request->price;
        self::$updateItem->product_unit = $request->product_unit;
